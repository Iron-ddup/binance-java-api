...
public class BinanceApiAsyncRestClientImpl implements BinanceApiAsyncRestClient {
  ...
  @Override
  public void withdraw(String coin, String address, String amount, String name, String addressTag,String network, BinanceApiCallback<WithdrawResult> callback) {
    binanceApiService.withdraw(coin, address, amount, name, addressTag,network, BinanceApiConstants.DEFAULT_RECEIVING_WINDOW, System.currentTimeMillis())
        .enqueue(new BinanceApiCallbackAdapter<>(callback));
  }
